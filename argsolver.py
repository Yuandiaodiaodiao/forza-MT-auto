...
parser.add_argument('--stop', type=str, help='急停',default="f11")
...
parser.add_argument('--record',  help='dc指纹',type=str,default="f10")
parser.add_argument('--anaGear',  help='dc指纹',type=str,default="f9")
